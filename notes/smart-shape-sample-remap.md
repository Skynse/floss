...
3. At each fitted vertex, interpolate the raw sample at the matching arc position (pressure, tilt, twist, time, pointer metadata).
4. Replace only X/Y with the fitted geometry (layer-local for rasterization).
