...
public static class BaseColorMaskEngine
{
    ...
    private static string ConsentFlagPath =>
        Path.Combine(AppPaths.AppDirectory, "model_consent");
    ...
    public static void GrantConsent()
    {
        ...
        try { Directory.CreateDirectory(AppPaths.AppDirectory); File.WriteAllText(ConsentFlagPath, "ok"); }
        catch { /* best effort */ }
    }
    ...
    public static Task PrewarmAsync() => EnsureModelReadyAsync();
