    ...
    private static void ApplyInput(IInputProcess input, ToolPreset preset)
    {
        switch (input)
        {
            ...
            case LiquifyInputProcess liquify:
                ...
                break;
            case ObjectInputProcess objectInput:
                objectInput.SelectableFlags = preset.SelectableObjectFlags;
                break;
        }
    }
    ...
    private static void ApplyOutput(IOutputProcess output, ToolPreset preset)
    {
        ...
        switch (output)
        {
            ...
            case MagicWandOutput wand:
                ...
                wand.Antialiasing = preset.AntialiasingQuality != AntialiasingQuality.None;
                break;
