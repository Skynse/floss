...
// Object tool manipulation gesture (selection / handle drag).
public sealed class ObjectManipulationInput : IProcessedInput
{
    public static readonly ObjectManipulationInput Instance = new();
    private ObjectManipulationInput() { }
}
