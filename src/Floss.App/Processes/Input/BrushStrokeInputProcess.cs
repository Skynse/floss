...
// stabilizer mode: fixed-size deque prefilled at stroke start, uniform
...
public sealed class BrushStrokeInputProcess : IInputProcess
{
    ...
    // effectiveSmoothnessDistance → sample count (max distance default 50).
    ...
    // getStabilizedPaintInfo — incremental uniform average (position + pressure).
