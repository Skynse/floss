...
/// <summary>
/// blend mode enum. Replaces all string-based blend mode dispatch.
...
public enum BlendMode : byte
{
    ...
    Color,
    Luminosity,
    // Alpha-preserving variant of Normal ()
...
{
    /// <summary>: true for alpha-preserving modes.</summary>
    ...
    /// <summary>
    /// : returns alpha-preserving variant when clip=true.
