...
/// <summary>
/// Classic brush stamp LUTs — 8-bit masks.
/// Exact algorithm port from paint.c, outputting byte[] [0,255].
/// Ported features:
...
/// - Small-brush fudge factors (matching empirical values)
/// </summary>
public static class ClassicBrushLut
{
    // ── Constants matching exactly ────────────────────────────────
    ...
    private static BrushStamp GetMask(float radius, int hardness, byte[] buffer)
    {
        ...
        // Empirically determined fudge factors (exact match)
    ...
    /// Main entry point — matches get_classic_mask_stamp.
    /// </summary>
    /// <param name="radius">Brush radius in pixels.</param>
    /// <param name="hardness">Hardness 0-100 (scaled_hardness).</param>
