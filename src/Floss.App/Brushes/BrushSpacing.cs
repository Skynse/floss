...
// Auto ON uses sqrt curve with coeff derived from that % at brush.Size so
...
public static class BrushSpacing
{
    ...
    /// while Spacing stayed at the 0.1 placeholder ().
    /// </summary>
    ...
    /// <summary>
    /// One-time normalization when loading a saved preset that still uses GapMode authoring.
    /// </summary>
