...
public sealed class ToolContext
{
    ...
    /// <summary>True while compositor or projection scheduler has pending work (preview throttle).</summary>
    ...
    /// <summary>Switch the active tool preset by id (e.g. Object tool after ruler creation).</summary>
    public Action<string>? ActivatePresetById { get; init; }
