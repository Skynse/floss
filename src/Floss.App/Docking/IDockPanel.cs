...
public interface IDockPanel
{
    ...
    /// <summary>Scroll / wrapper policy for the panel body.</summary>
    DockBodyChrome BodyChrome { get; }

    /// <summary>
    /// Called after visibility toggles (Window → Dockers, context menu). Not used for float/dock moves.
    /// </summary>
