...
AI is seldom used in this project. When profiling this software in the past, I used deepseek to run perf counters while i did some intensive operation, and this helps me pin-point where issues are quickly, although I could just skim through the flamecharts though that'd take a bit longer. AI in my case is used where it would make sense -- To *possibly* improve already existing code, and to debug. Discretion is at the hands of the developer as these models are prone to hallucination.
