...
public class PresetStoreTests
{
    ...
    public void ToolGroups_RoundTrip()
    {
        ...
        try
        {
            ...
            TestAssertions.Equal(ToolKind.Brush, groups[0].Presets[0].Kind);
    ...
    public void ToolGroups_SyncCategorizesBrushAssets()
    {
        var config = new ToolGroupConfig
        {
            Groups =
            [
                new ToolGroup { Id = "brush", Name = "Brush", DefaultKind = ToolKind.Brush },
                new ToolGroup { Id = "eraser", Name = "Eraser", DefaultKind = ToolKind.Eraser }
            ]
        };
    ...
    private static bool IsAssetBackedEmptyBeforeSync(ToolGroup group)
        => group.DefaultKind is ToolKind.Brush or ToolKind.Eraser
    ...
    public void Packages_ExportSubTool()
    {
        ...
        try
        {
            ...
            var group = new ToolGroup
            {
                ...
                Presets = [preset, new ToolPreset { Id = "other", Name = "Other", Kind = ToolKind.Fill }],
    ...
    public void Packages_ExportSubToolGroup()
    {
        ...
        try
        {
            ...
            var group = new ToolGroup
            {
                ...
                Presets =
                [
                    new ToolPreset { Id = "preset-one", Name = "One", Kind = ToolKind.Brush, BrushId = assetOne.Id },
                    new ToolPreset { Id = "preset-two", Name = "Two", Kind = ToolKind.Brush, BrushId = assetTwo.Id },
                    new ToolPreset { Id = "fill", Name = "Fill", Kind = ToolKind.Fill }
                ],
